# This installer script is adapted from the install script defined in the
# golangci-lint project, which itself was adapted from some previous scripts.
#
# The unmodified version script can be found at:
# https://github.com/golangci/golangci-lint/blob/78a738f7cbcedac710e8de83e10cbf5721061114/install.sh
#
...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for golangci/fhenix
...
get_binaries() {
  case "$PLATFORM" in
    ...
    darwin/mips64) BINARIES="${PROJECT_NAME}" ;;
    darwin/mips64le) BINARIES="${PROJECT_NAME}" ;;
    darwin/ppc64le) BINARIES="${PROJECT_NAME}" ;;
    ...
    freebsd/mips64le) BINARIES="${PROJECT_NAME}" ;;
    ...
    linux/mips64) BINARIES="${PROJECT_NAME}" ;;
    linux/mips64le) BINARIES="${PROJECT_NAME}" ;;
    linux/ppc64le) BINARIES="${PROJECT_NAME}" ;;
    linux/s390x) BINARIES="${PROJECT_NAME}" ;;
    linux/riscv64) BINARIES="${PROJECT_NAME}" ;;
    ...
    windows/mips64) BINARIES="${PROJECT_NAME}" ;;
    windows/mips64le) BINARIES="${PROJECT_NAME}" ;;
    windows/ppc64le) BINARIES="${PROJECT_NAME}" ;;
    windows/s390x) BINARIES="${PROJECT_NAME}" ;;
    *)
